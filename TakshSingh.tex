  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItemWithoutBold
        {
            Increased performance and reduced failure rate for distributed job framework, by overhauling its throttling architecture, allowing resources to be used more efficiently and fixing certain correctness bugs caused when jobs are interrupted.
            \color{blue}{(Shortlisted as patent candidate)}
        }
        \resumeItemWithoutBold
        {
