...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Bachelor of Science in Computer Science;  GPA: 3.85}{Aug 2019 -- Dec 2022}
      \resumeItemListStart
        \resumeItem{Coursework}
        {Distributed Systems, Machine Learning, Deep Learning, Functional Programming, IoT, Systems Programming, Probability and Statistics, Data Structures, Algorithms, Computer Architecture}
        \resumeItem{Fun Stuff}
        {Staff member for largest hackathon in the Midwest: Hackillinois. Helped maintain the backend API for the event, which managed 1000+ users.}
      \resumeItemListEnd
...
\section{Experience}
  ...
  \resumeSubheading
      ...
      \resumeItemListStart
        ...
        {
        Scaled up our test execution infra, by reducing Github API usage for CI status management by 75\%, through a new service that tracked jobs triggered for pull requests independent of Github.
        }
        \resumeItemWithoutBold
        {
        Proved correctness of new service (match rate between Github and new service above 99\%) through automated script for differential testing.
        }
        \resumeItemWithoutBold
        {
        Deployed changes to production in shadow mode and verified that the match rate was above 95\% through runtime checks.
        }
      \resumeItemListEnd
...
\section{Skills}
 \resumeSubHeadingListStart
   \item{
     \textbf{Languages}{: Python, Haskell, Scala, Java, C/C++, JavaScript}
     \hfill
     \textbf{Technologies}{: Kubernetes, Linux, Node.js}
   }
 \resumeSubHeadingListEnd
